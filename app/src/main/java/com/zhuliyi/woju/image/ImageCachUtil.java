...
public class ImageCachUtil {
    ...
    private static ImageCachUtil inst;
    private final String ImageExternalCatchDir = App.getInstance().getExternalCacheDir() + "/image_cache";

    public static ImageCachUtil getInstance() {
        if (inst == null) {
            inst = new ImageCachUtil();
        }
        return inst;
    }
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(App.getInstance().getCacheDir() + "/image_cache")));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
