package com.zhulilyi.woju.widget.cycleView;
...
public class ImageCycleView extends LinearLayout {
	...
	public void setImageResources(ArrayList<String> imageDesList, ArrayList<String> imageUrlList, ImageCycleViewListener imageCycleViewListener) {
		...
		imageName.setTextColor(getResources().getColor(R.color.colorPrimary));
...
//			return mAdList.size();
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			if (mImageViewCacheList.isEmpty()) {
				view = View.inflate(mContext, R.layout.item_cycle_view, null);
	 ...
	 * 隐藏指示器
	 */
	public void hideIndicator(boolean isHide){
		if(isHide){
